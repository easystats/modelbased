...
---
    ...
    Output
      ...
      -----------------------------------------------------------------------------------
      Male - Male     |   low - mid |      -0.29 | 0.71 | [-1.68,  1.10] |  -0.41 | 0.684
      Male - Female   |   low - mid |      -0.85 | 0.64 | [-2.10,  0.40] |  -1.33 | 0.183
      Female - Female |   low - mid |       0.20 | 0.39 | [-0.57,  0.96] |   0.51 | 0.613
      Male - Male     |  low - high |      -0.69 | 0.83 | [-2.32,  0.95] |  -0.82 | 0.410
      Male - Female   |  low - high |      -1.65 | 0.71 | [-3.05, -0.24] |  -2.30 | 0.022
      Female - Female |  low - high |      -0.60 | 0.51 | [-1.59,  0.39] |  -1.18 | 0.236
      Male - Female   |   low - low |      -1.05 | 0.69 | [-2.40,  0.31] |  -1.51 | 0.131
      Male - Male     |  mid - high |      -0.40 | 0.68 | [-1.73,  0.94] |  -0.59 | 0.558
      Male - Female   |  mid - high |      -1.36 | 0.53 | [-2.39, -0.32] |  -2.58 | 0.010
      Female - Female |  mid - high |      -0.80 | 0.43 | [-1.63,  0.04] |  -1.87 | 0.061
      Male - Female   |   mid - low |      -0.76 | 0.50 | [-1.73,  0.22] |  -1.52 | 0.129
      Male - Female   |   mid - mid |      -0.56 | 0.42 | [-1.38,  0.26] |  -1.35 | 0.178
      Male - Female   |  high - low |      -0.36 | 0.66 | [-1.66,  0.95] |  -0.54 | 0.589
      Male - Female   |  high - mid |      -0.16 | 0.61 | [-1.35,  1.03] |  -0.27 | 0.789
      Male - Female   | high - high |      -0.96 | 0.69 | [-2.30,  0.39] |  -1.40 | 0.163
...
---
    ...
    Output
      ...
      ----------------------------------------------------------------------------------
      low - low   |   male - female |       0.01 | 0.02 | [-0.03,  0.04] |  0.35 | 0.729
      low - mid   |   male - female |      -0.02 | 0.01 | [-0.05,  0.01] | -1.24 | 0.216
      low - high  |   male - female |      -0.02 | 0.02 | [-0.06,  0.01] | -1.19 | 0.236
      mid - mid   |   male - female |      -0.03 | 0.01 | [-0.05,  0.00] | -2.24 | 0.025
      mid - high  |   male - female |      -0.03 | 0.02 | [-0.06,  0.00] | -1.83 | 0.067
      high - high |   male - female |      -0.03 | 0.02 | [-0.07,  0.02] | -1.11 | 0.268
      low - mid   |     male - male |       0.01 | 0.02 | [-0.02,  0.04] |  0.46 | 0.648
      low - high  |     male - male |       0.00 | 0.02 | [-0.04,  0.05] |  0.16 | 0.876
      mid - high  |     male - male |       0.00 | 0.02 | [-0.05,  0.04] | -0.18 | 0.859
      low - mid   |   female - male |       0.00 | 0.02 | [-0.03,  0.03] |  0.08 | 0.940
      low - high  |   female - male |       0.00 | 0.02 | [-0.05,  0.04] | -0.12 | 0.908
      mid - high  |   female - male |       0.02 | 0.02 | [-0.02,  0.06] |  1.08 | 0.280
      low - mid   | female - female |      -0.02 | 0.01 | [-0.05,  0.00] | -1.76 | 0.079
      low - high  | female - female |      -0.03 | 0.02 | [-0.06,  0.01] | -1.58 | 0.115
      mid - high  | female - female |       0.00 | 0.01 | [-0.03,  0.02] | -0.26 | 0.792
...
---
    ...
    Output
      ...
      -------------------------------------------------------------------------------
      yes - yes |       GP - PR |      -0.06 | 0.05 | [-0.16,  0.04] | -1.10 | 0.271 
      yes - no  |       GP - PR |      -0.51 | 0.16 | [-0.82, -0.20] | -3.21 | 0.001 
      no - no   |       GP - PR |       2.08 | 0.48 | [ 1.14,  3.02] |  4.35 | < .001
      yes - yes |       GP - DM |      -0.32 | 0.11 | [-0.54, -0.10] | -2.89 | 0.004 
      yes - no  |       GP - DM |      -2.86 | 0.61 | [-4.05, -1.68] | -4.73 | < .001
      no - no   |       GP - DM |      -0.27 | 0.37 | [-1.00,  0.46] | -0.73 | 0.466 
      yes - yes |     GP - EC-A |      -0.04 | 0.05 | [-0.13,  0.05] | -0.80 | 0.421 
      yes - no  |     GP - EC-A |      -1.10 | 0.27 | [-1.64, -0.57] | -4.03 | < .001
      no - no   |     GP - EC-A |       1.49 | 0.41 | [ 0.68,  2.29] |  3.61 | < .001
      yes - yes |     GP - EC-L |      -0.17 | 0.08 | [-0.32, -0.02] | -2.19 | 0.028 
      yes - no  |     GP - EC-L |      -4.67 | 0.94 | [-6.52, -2.82] | -4.95 | < .001
      no - no   |     GP - EC-L |      -2.08 | 0.58 | [-3.21, -0.95] | -3.61 | < .001
      yes - yes |    GP - DES-L |      -0.43 | 0.14 | [-0.70, -0.17] | -3.19 | 0.001 
      yes - no  |    GP - DES-L |      -4.62 | 0.93 | [-6.45, -2.79] | -4.95 | < .001
      no - no   |    GP - DES-L |      -2.03 | 0.57 | [-3.15, -0.92] | -3.57 | < .001
      yes - yes |       GP - DF |      -0.43 | 0.14 | [-0.70, -0.17] | -3.19 | 0.001 
      yes - no  |       GP - DF |      -2.24 | 0.49 | [-3.20, -1.28] | -4.58 | < .001
      no - no   |       GP - DF |       0.35 | 0.35 | [-0.35,  1.04] |  0.98 | 0.328 
      yes - no  |       GP - GP |      -2.59 | 0.55 | [-3.67, -1.50] | -4.67 | < .001
      yes - yes |       PR - DM |      -0.26 | 0.11 | [-0.48, -0.05] | -2.43 | 0.015 
      yes - no  |       PR - DM |      -2.80 | 0.61 | [-4.00, -1.61] | -4.61 | < .001
      no - no   |       PR - DM |      -2.35 | 0.53 | [-3.39, -1.32] | -4.47 | < .001
      yes - yes |     PR - EC-A |       0.02 | 0.06 | [-0.09,  0.13] |  0.33 | 0.740 
      yes - no  |     PR - EC-A |      -1.05 | 0.28 | [-1.59, -0.50] | -3.76 | < .001
      no - no   |     PR - EC-A |      -0.59 | 0.23 | [-1.05, -0.14] | -2.56 | 0.011 
      yes - yes |     PR - EC-L |      -0.11 | 0.08 | [-0.27,  0.04] | -1.43 | 0.154 
      yes - no  |     PR - EC-L |      -4.61 | 0.95 | [-6.47, -2.76] | -4.87 | < .001
      no - no   |     PR - EC-L |      -4.16 | 0.86 | [-5.84, -2.49] | -4.87 | < .001
      yes - yes |    PR - DES-L |      -0.38 | 0.13 | [-0.64, -0.12] | -2.86 | 0.004 
      yes - no  |    PR - DES-L |      -4.56 | 0.94 | [-6.40, -2.73] | -4.87 | < .001
      no - no   |    PR - DES-L |      -4.11 | 0.85 | [-5.77, -2.45] | -4.86 | < .001
      yes - yes |       PR - DF |      -0.38 | 0.13 | [-0.64, -0.12] | -2.86 | 0.004 
      yes - no  |       PR - DF |      -2.18 | 0.49 | [-3.15, -1.22] | -4.44 | < .001
      no - no   |       PR - DF |      -1.73 | 0.42 | [-2.55, -0.92] | -4.15 | < .001
      yes - no  |       PR - GP |      -2.53 | 0.56 | [-3.62, -1.44] | -4.54 | < .001
      yes - no  |       PR - PR |      -0.45 | 0.16 | [-0.77, -0.13] | -2.75 | 0.006 
      yes - yes |     DM - EC-A |       0.28 | 0.11 | [ 0.07,  0.50] |  2.59 | 0.010 
      yes - no  |     DM - EC-A |      -0.78 | 0.31 | [-1.38, -0.18] | -2.56 | 0.011 
      no - no   |     DM - EC-A |       1.76 | 0.46 | [ 0.87,  2.65] |  3.86 | < .001
      yes - yes |     DM - EC-L |       0.15 | 0.11 | [-0.06,  0.36] |  1.39 | 0.164 
      yes - no  |     DM - EC-L |      -4.35 | 0.96 | [-6.24, -2.46] | -4.51 | < .001
      no - no   |     DM - EC-L |      -1.81 | 0.55 | [-2.89, -0.73] | -3.29 | < .001
      yes - yes |    DM - DES-L |      -0.11 | 0.13 | [-0.36,  0.14] | -0.89 | 0.375 
      yes - no  |    DM - DES-L |      -4.30 | 0.95 | [-6.17, -2.43] | -4.51 | < .001
      no - no   |    DM - DES-L |      -1.76 | 0.54 | [-2.82, -0.70] | -3.24 | 0.001 
      yes - yes |       DM - DF |      -0.11 | 0.13 | [-0.36,  0.14] | -0.89 | 0.375 
      yes - no  |       DM - DF |      -1.92 | 0.51 | [-2.93, -0.91] | -3.74 | < .001
      no - no   |       DM - DF |       0.62 | 0.38 | [-0.12,  1.36] |  1.65 | 0.100 
      yes - no  |       DM - GP |      -2.27 | 0.58 | [-3.40, -1.14] | -3.93 | < .001
      yes - no  |       DM - PR |      -0.19 | 0.20 | [-0.58,  0.21] | -0.93 | 0.352 
      yes - no  |       DM - DM |      -2.54 | 0.63 | [-3.77, -1.31] | -4.04 | < .001
      yes - yes |   EC-A - EC-L |      -0.13 | 0.08 | [-0.29,  0.02] | -1.68 | 0.093 
      yes - no  |   EC-A - EC-L |      -4.63 | 0.95 | [-6.48, -2.78] | -4.90 | < .001
      no - no   |   EC-A - EC-L |      -3.57 | 0.77 | [-5.07, -2.07] | -4.66 | < .001
      yes - yes |  EC-A - DES-L |      -0.40 | 0.13 | [-0.66, -0.14] | -2.97 | 0.003 
      yes - no  |  EC-A - DES-L |      -4.58 | 0.94 | [-6.42, -2.75] | -4.90 | < .001
      no - no   |  EC-A - DES-L |      -3.52 | 0.76 | [-5.00, -2.03] | -4.65 | < .001
      yes - yes |     EC-A - DF |      -0.40 | 0.13 | [-0.66, -0.14] | -2.97 | 0.003 
      yes - no  |     EC-A - DF |      -2.20 | 0.49 | [-3.17, -1.24] | -4.49 | < .001
      no - no   |     EC-A - DF |      -1.14 | 0.36 | [-1.85, -0.43] | -3.16 | 0.002 
      yes - no  |     EC-A - GP |      -2.55 | 0.56 | [-3.64, -1.46] | -4.58 | < .001
      yes - no  |     EC-A - PR |      -0.47 | 0.16 | [-0.79, -0.15] | -2.90 | 0.004 
      yes - no  |     EC-A - DM |      -2.82 | 0.61 | [-4.01, -1.63] | -4.65 | < .001
      yes - no  |   EC-A - EC-A |      -1.06 | 0.28 | [-1.61, -0.52] | -3.85 | < .001
      yes - yes |  EC-L - DES-L |      -0.26 | 0.13 | [-0.51, -0.02] | -2.08 | 0.037 
      yes - no  |  EC-L - DES-L |      -4.45 | 0.94 | [-6.30, -2.60] | -4.71 | < .001
      no - no   |  EC-L - DES-L |       0.05 | 0.48 | [-0.89,  0.99] |  0.10 | 0.918 
      yes - yes |     EC-L - DF |      -0.26 | 0.13 | [-0.51, -0.02] | -2.08 | 0.037 
      yes - no  |     EC-L - DF |      -2.07 | 0.50 | [-3.05, -1.09] | -4.14 | < .001
      no - no   |     EC-L - DF |       2.43 | 0.61 | [ 1.22,  3.63] |  3.95 | < .001
      yes - no  |     EC-L - GP |      -2.42 | 0.57 | [-3.53, -1.31] | -4.28 | < .001
      yes - no  |     EC-L - PR |      -0.34 | 0.18 | [-0.69,  0.01] | -1.89 | 0.058 
      yes - no  |     EC-L - DM |      -2.69 | 0.62 | [-3.90, -1.48] | -4.37 | < .001
      yes - no  |   EC-L - EC-A |      -0.93 | 0.29 | [-1.50, -0.37] | -3.23 | 0.001 
      yes - no  |   EC-L - EC-L |      -4.50 | 0.95 | [-6.37, -2.63] | -4.72 | < .001
      yes - yes |    DES-L - DF |       0.00 | 0.13 | [-0.26,  0.26] |  0.00 | > .999
      yes - no  |    DES-L - DF |      -1.81 | 0.52 | [-2.83, -0.78] | -3.45 | < .001
      no - no   |    DES-L - DF |       2.38 | 0.61 | [ 1.19,  3.57] |  3.92 | < .001
      yes - no  |    DES-L - GP |      -2.15 | 0.59 | [-3.31, -1.00] | -3.67 | < .001
      yes - no  |    DES-L - PR |      -0.07 | 0.22 | [-0.50,  0.36] | -0.33 | 0.738 
      yes - no  |    DES-L - DM |      -2.43 | 0.64 | [-3.68, -1.18] | -3.81 | < .001
      yes - no  |  DES-L - EC-A |      -0.67 | 0.32 | [-1.29, -0.04] | -2.09 | 0.037 
      yes - no  |  DES-L - EC-L |      -4.24 | 0.97 | [-6.14, -2.33] | -4.36 | < .001
      yes - no  | DES-L - DES-L |      -4.19 | 0.96 | [-6.07, -2.30] | -4.35 | < .001
      yes - no  |       DF - GP |      -2.15 | 0.59 | [-3.31, -1.00] | -3.67 | < .001
      yes - no  |       DF - PR |      -0.07 | 0.22 | [-0.50,  0.36] | -0.33 | 0.738 
      yes - no  |       DF - DM |      -2.43 | 0.64 | [-3.68, -1.18] | -3.81 | < .001
      yes - no  |     DF - EC-A |      -0.67 | 0.32 | [-1.29, -0.04] | -2.09 | 0.037 
      yes - no  |     DF - EC-L |      -4.24 | 0.97 | [-6.14, -2.33] | -4.36 | < .001
      yes - no  |    DF - DES-L |      -4.19 | 0.96 | [-6.07, -2.30] | -4.35 | < .001
      yes - no  |       DF - DF |      -1.81 | 0.52 | [-2.83, -0.78] | -3.45 | < .001
