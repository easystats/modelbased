...
ggplot(iris, aes(x = Species, y = Sepal.Width, fill = Species)) +
  ...
  geom_pointrange(data = means_complex, aes(y = Median, ymin = CI_low, ymax = CI_high), size = 1, color = "orange") +
  theme_modern()
```

That's interesting: it seems that when adjusting the model for petal charactertistics, the differences between Species seems to be even bigger!
