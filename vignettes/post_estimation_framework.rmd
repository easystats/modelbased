...
```{r, echo=FALSE, fig.cap="Figure 4: Comparison of Trends in PHQ-15 by Stigma Groups"}
plot(result)
```
...
```{r, echo=FALSE, fig.cap="Figure 5: Interaction Contrasts - Evaluating the Change in Group Differences Over Time"}
plot(result)
```
...
```{r, echo=FALSE, fig.width = 10, fig.height = 8, fig.cap="Figure 6: Interaction Contrasts - Evaluating the Change in Group Differences Over Time Across Groups"}
