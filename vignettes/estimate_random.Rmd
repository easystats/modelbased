...
```{r warning=FALSE, message=FALSE}
data_rt <- dplyr::full_join(data_rt, reshaped, by = "id")
```
...
The parameters suggest that in general, participants indeed make more errors in the speed condition as compared to the accuracy condition.
