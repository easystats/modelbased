...
`estimate_smooth` will decompose this curve into linear parts, returning their
...
ggplot(estim, aes(x = Delay, y = Predicted)) +
  ...
  geom_ribbon(aes(ymin = CI_low_0.50, ymax = CI_high_0.50), alpha = 0.2, fill = "blue") +
