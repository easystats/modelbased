...
created above, because we just have a single, categorical predictor in our model. For more complex models, we can adjust the predicted means for other confounders and, as a result, will also get *adjusted means*.
