...
print(report::report(cor.test(data$y, data$x)), width = 100)
```
...
Again, the GAM nicely recovered the shape of the relationship. In summary, effects derivatives can be used to leverage the power of GAMs.
