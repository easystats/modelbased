...
You might have heard of **General Additive Models**, aka **GAMs**, that extend general linear models (GLMs) by enabling a way to model non-linear relationships. But we can also use them **for linear links**, or, in general, if we are not sure about the exact shape of the relationship. Because GAMs usually penalize wiggly patterns, they have no problems with approximating linear relationship with this is what the data indicates.
