...
We first look at the simple effect of `treatment`, which is about `10.7`.
...
Now we run the same model again, including the weights. We see that the treatment effect, after weighting, is about `10.8` points, i.e. the treatment on average results in a (roughly) 11-point higher score for QoL.
