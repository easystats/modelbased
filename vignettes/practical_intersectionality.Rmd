...
We can easily compute the strata-level residuals using the `estimate_grouplevel()` function. **Important**: We need to calculate these residuals for the *main effects* (full) model, not for the *null* model.
