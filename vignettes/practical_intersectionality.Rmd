...
::: custom_note
 The ICC (or VPC) and the PCV are *global* measures of intersectionality. There is also an additional *specific* measure of intersectionality, the strata-level residuals, which will be introduced in section 6.
:::
