...
5. Look at group-level estimates (BLUPs), which represent the group-level residuals (also called _strata-level residuals_, see @keller_educational_2023), to see whether we find additive or multiplicative effects for strata.
