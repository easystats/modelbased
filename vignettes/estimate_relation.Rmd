...
Note that the statistically correct name of `estimate_relation` is `estimate_expectation` (which can be used as an alias), as it refers to expected predictions (see [more](https://easystats.github.io/insight/reference/get_predicted.html)). 
...
visualization_data <- modelbased::estimate_relation(model)
