...
1. [**Significance Testing of Differences Between Predictions I: Contrasts and Pairwise Comparisons**](https://easystats.github.io/modelbased/articles/introduction_comparisons_1.html)
...
We will start with the conditional mean, using `margin = "empirical"`, as we want to average predictions across random effects (see [introduction on random effects](https://easystats.github.io/modelbased/articles/introduction_randomeffects.html) for details).
