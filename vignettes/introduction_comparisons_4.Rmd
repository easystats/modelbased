...
- The **zero-inflation probabilities**, which predicts the probabilities whether an observation is a "true zero" or not. Again, this option depeends on the model-class. Use option like `predict = "zprob"` or `predict = "zero"`. These predictions only related to the zero-inflation component of the model.
