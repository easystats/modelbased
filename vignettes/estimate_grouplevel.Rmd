...
Similarly, we can extract the group-level effects, clean them (rename the colums, otherwise it will be the same names as for the RT model), and merge them with the previous ones. 
