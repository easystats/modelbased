...
```{r, warning=FALSE, echo=FALSE, fig.width = 9, fig.height = 7.5, fig.cap="Figure 7: Interaction Contrasts - Evaluating the Change in Group Differences Over Time Across Groups"}
