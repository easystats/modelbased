...
This vignette illustrates a two-step framework for statistical modeling, which we call the *modelisation approach*.
...
This is an often-neglected, yet crucial step in data analysis. Depending on your research question, it may be necessary to "control for a confounder" to reduce bias. However, in other situations, that exact same variable might act not as a confounder, but as a mediator - which dictates that it should be omitted from the model [@rohrer_models_2026].
