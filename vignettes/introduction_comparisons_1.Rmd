...
7. Our quantity of interest is the difference between these two differences, which is (considering rounding inaccuray) 0.36. This difference is not statistically significant (p = 0.277).
