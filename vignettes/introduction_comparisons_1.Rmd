...
2. Predicted value of _outcome_ for `episode = 2` in the control group is -0.39.
3. The first difference is 0.42.
4. Predicted value of _outcome_ for `episode = 1` in the treatment group is 0.18.
5. Predicted value of _outcome_ for `episode = 2` in the treatment group is -0.04.
6. The second difference is 0.22.
7. Our quantity of interest is the difference between these two differences, which is 0.20. This difference is not statistically significant (p = 0.277).
