...
This vignette will present how to visualize the effects and interactions using `estimate_link()`.
...
Note that non-linear relationships can be also described by linear approximations using [**estimate_smooth**](https://easystats.github.io/modelbased/articles/estimate_smooth.html).
