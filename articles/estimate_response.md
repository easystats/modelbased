...
\
`model`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``Petal.Length`` ``~`` ``Sepal.Length``, data ``=`` ``iris``)`
...
\
`pred_data`` ``<-`` `[`estimate_expectation`](https://easystats.github.io/modelbased/reference/estimate_expectation.md)`(``model``)`\
[`head`](https://rdrr.io/r/utils/head.html)`(``pred_data``)`
...
\
`pred_data`` ``|>`\
`  `[`ggplot`](https://ggplot2.tidyverse.org/reference/ggplot.html)`(`[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``x ``=`` ``Petal.Length``, y ``=`` ``Predicted``)``)`` ``+`\
`  `[`geom_line`](https://ggplot2.tidyverse.org/reference/geom_path.html)`(`[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``x ``=`` ``Petal.Length``, y ``=`` ``Petal.Length``)``, linetype ``=`` ``"dashed"``)`` ``+`\
`  `[`geom_point`](https://ggplot2.tidyverse.org/reference/geom_point.html)`(``)`` ``+`\
`  `[`ylab`](https://ggplot2.tidyverse.org/reference/labs.html)`(``"Petal.Length (predicted)"``)`` ``+`\
...
\
`model`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``Petal.Length`` ``~`` ``Sepal.Length`` ``*`` ``Species``, data ``=`` ``iris``)`\
\
`pred_data``$``Predicted_2`` ``<-`` `[`estimate_expectation`](https://easystats.github.io/modelbased/reference/estimate_expectation.md)`(``model``)``$``Predicted`
...
`  `[`geom_line`](https://ggplot2.tidyverse.org/reference/geom_path.html)`(`[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``x ``=`` ``Petal.Length``, y ``=`` ``Petal.Length``)``, linetype ``=`` ``"dashed"``)`` ``+`\
`  `[`geom_point`](https://ggplot2.tidyverse.org/reference/geom_point.html)`(`[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``x ``=`` ``Petal.Length``, y ``=`` ``Predicted``)``, color ``=`` ``"grey"``)`` ``+`\
`  `[`geom_point`](https://ggplot2.tidyverse.org/reference/geom_point.html)`(`[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``x ``=`` ``Petal.Length``, y ``=`` ``Predicted_2``)``, color ``=`` ``"red"``)`` ``+`\
`  `[`ylab`](https://ggplot2.tidyverse.org/reference/labs.html)`(``"Petal.Length (predicted)"``)`` ``+`\
`  `[`theme_minimal`](https://ggplot2.tidyverse.org/reference/ggtheme.html)`(``)`
...
\
`predicted`` ``<-`` `[`estimate_expectation`](https://easystats.github.io/modelbased/reference/estimate_expectation.md)`(``model``, data ``=`` ``"grid"``)`\
\
`iris`` ``|>`\
`  `[`ggplot`](https://ggplot2.tidyverse.org/reference/ggplot.html)`(`[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``x ``=`` ``Sepal.Length``)``)`` ``+`\
`  `[`geom_point`](https://ggplot2.tidyverse.org/reference/geom_point.html)`(`[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``y ``=`` ``Petal.Length``, color ``=`` ``Species``)``)`` ``+`\
`  `[`geom_ribbon`](https://ggplot2.tidyverse.org/reference/geom_ribbon.html)`(``data ``=`` ``predicted``, `[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``ymin ``=`` ``CI_low``, ymax ``=`` ``CI_high``, fill ``=`` ``Species``)``, alpha ``=`` ``0.3``)`` ``+`\
`  `[`geom_line`](https://ggplot2.tidyverse.org/reference/geom_path.html)`(``data ``=`` ``predicted``, `[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``y ``=`` ``Predicted``, color ``=`` ``Species``)``, linewidth ``=`` ``1``)`` ``+`\
`  `[`theme_minimal`](https://ggplot2.tidyverse.org/reference/ggtheme.html)`(``)`
...
\
`predicted`` ``<-`` `[`estimate_relation`](https://easystats.github.io/modelbased/reference/estimate_expectation.md)`(``model``)`\
\
`iris`` ``|>`\
`  `[`ggplot`](https://ggplot2.tidyverse.org/reference/ggplot.html)`(`[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``x ``=`` ``Sepal.Length``)``)`` ``+`\
`  `[`geom_point`](https://ggplot2.tidyverse.org/reference/geom_point.html)`(`[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``y ``=`` ``Petal.Length``, color ``=`` ``Species``)``)`` ``+`\
...
\
`predicted`` ``<-`` `[`estimate_relation`](https://easystats.github.io/modelbased/reference/estimate_expectation.md)`(``model``, ci ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``0.69``, ``0.89``, ``0.99``)``)`\
\
`iris`` ``|>`\
`  `[`ggplot`](https://ggplot2.tidyverse.org/reference/ggplot.html)`(`[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``x ``=`` ``Sepal.Length``)``)`` ``+`\
`  `[`geom_point`](https://ggplot2.tidyverse.org/reference/geom_point.html)`(`[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``y ``=`` ``Petal.Length``, color ``=`` ``Species``)``)`` ``+`\
`  `[`geom_ribbon`](https://ggplot2.tidyverse.org/reference/geom_ribbon.html)`(``data ``=`` ``predicted``, `[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``ymin ``=`` ``CI_low_0.99``, ymax ``=`` ``CI_high_0.99``, fill ``=`` ``Species``)``, alpha ``=`` ``0.2``)`` ``+`\
`  `[`geom_ribbon`](https://ggplot2.tidyverse.org/reference/geom_ribbon.html)`(``data ``=`` ``predicted``, `[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``ymin ``=`` ``CI_low_0.89``, ymax ``=`` ``CI_high_0.89``, fill ``=`` ``Species``)``, alpha ``=`` ``0.3``)`` ``+`\
`  `[`geom_ribbon`](https://ggplot2.tidyverse.org/reference/geom_ribbon.html)`(``data ``=`` ``predicted``, `[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``ymin ``=`` ``CI_low_0.69``, ymax ``=`` ``CI_high_0.69``, fill ``=`` ``Species``)``, alpha ``=`` ``0.3``)`` ``+`\
`  `[`geom_line`](https://ggplot2.tidyverse.org/reference/geom_path.html)`(``data ``=`` ``predicted``, `[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``y ``=`` ``Predicted``, color ``=`` ``Species``)``, linewidth ``=`` ``1``)`` ``+`\
`  `[`theme_minimal`](https://ggplot2.tidyverse.org/reference/ggtheme.html)`(``)`
...
\
`model`` ``<-`` `[`stan_glm`](https://mc-stan.org/rstanarm/reference/stan_glm.html)`(``Petal.Length`` ``~`` ``Sepal.Length`` ``*`` ``Species``,`\
`  refresh ``=`` ``0``, seed ``=`` ``3``,`\
`  data ``=`` ``iris`\
`)`
...
`predicted`` ``<-`` `[`estimate_relation`](https://easystats.github.io/modelbased/reference/estimate_expectation.md)`(``model``, keep_iterations ``=`` ``TRUE``, iterations ``=`` ``100``)`\
\
`# Format draws for plotting`\
`iterations`` ``<-`` ``bayestestR``::`[`reshape_iterations`](https://easystats.github.io/bayestestR/reference/reshape_iterations.html)`(``predicted``)`\
`iterations``$``group`` ``<-`` `[`paste0`](https://rdrr.io/r/base/paste.html)`(``iterations``$``iter_group``, ``iterations``$``Species``)`\
\
`iris`` ``|>`\
`  `[`ggplot`](https://ggplot2.tidyverse.org/reference/ggplot.html)`(`[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``x ``=`` ``Sepal.Length``)``)`` ``+`\
`  `[`geom_point`](https://ggplot2.tidyverse.org/reference/geom_point.html)`(`[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``y ``=`` ``Petal.Length``, color ``=`` ``Species``)``)`` ``+`\
`  `[`geom_line`](https://ggplot2.tidyverse.org/reference/geom_path.html)`(``data ``=`` ``iterations``, `[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``y ``=`` ``iter_value``, color ``=`` ``Species``, group ``=`` ``group``)``, alpha ``=`` ``0.1``)`` ``+`\
`  `[`geom_line`](https://ggplot2.tidyverse.org/reference/geom_path.html)`(``data ``=`` ``predicted``, `[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``y ``=`` ``Predicted``, color ``=`` ``Species``)``, linewidth ``=`` ``1``)`` ``+`\
`  `[`theme_minimal`](https://ggplot2.tidyverse.org/reference/ggtheme.html)`(``)`
...
`predicted`` ``<-`` `[`estimate_relation`](https://easystats.github.io/modelbased/reference/estimate_expectation.md)`(``model``, keep_iterations ``=`` ``TRUE``, iterations ``=`` ``50``)`\
\
`# Format draws for plotting`\
`iterations`` ``<-`` ``bayestestR``::`[`reshape_iterations`](https://easystats.github.io/bayestestR/reference/reshape_iterations.html)`(``predicted``)`\
`iterations``$``group`` ``<-`` `[`paste0`](https://rdrr.io/r/base/paste.html)`(``iterations``$``iter_group``, ``iterations``$``Species``)`\
