...
`#> 1.01       |   32.49 | 25.05 | [ -17.96,  82.95] |  1.30 | 0.201`\
`#> 1.27       |    7.65 | 26.42 | [ -45.56,  60.87] |  0.29 | 0.773`\
`#> 1.52       |  -17.09 | 30.59 | [ -78.70,  44.51] | -0.56 | 0.579`\
`#> 1.78       |  -41.93 | 36.64 | [-115.72,  31.85] | -1.14 | 0.258`\
`#> 2.03       |  -66.68 | 43.76 | [-154.82,  21.47] | -1.52 | 0.135`\
`#> 2.29       |  -91.52 | 51.58 | [-195.41,  12.37] | -1.77 | 0.083`\
`#> 2.54       | -116.27 | 59.72 | [-236.55,   4.02] | -1.95 | 0.058`\
`#> 2.80       | -141.11 | 68.18 | [-278.44,  -3.78] | -2.07 | 0.044`\
`#> `\
...
`#> 1.35  | 2.66 | negative  | Not Significant`\
`#> 2.67  | 2.80 | negative  | Significant    `\
`#> `\
`#> Marginal effects estimated for Murder`\
`#> Type of slope was dY/dX`
