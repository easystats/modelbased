...
\
[`data`](https://rdrr.io/r/utils/data.html)`(``puppy_love``, package ``=`` ``"modelbased"``)`\
\
`# the levels for our treatment variable`\
[`levels`](https://rdrr.io/r/base/levels.html)`(``puppy_love``$``dose``)`\
`#> [1] "No puppies" "15 mins"    "30 mins"`\
\
`# set contrasts`\
`treat_vs_none`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(``-``2`` ``/`` ``3``, ``1`` ``/`` ``3``, ``1`` ``/`` ``3``)`\
`short_vs_long`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(``0``, ``-``1`` ``/`` ``2``, ``1`` ``/`` ``2``)`\
\
...
[`contrasts`](https://rdrr.io/r/stats/contrasts.html)`(``puppy_love``$``dose``)`` ``<-`` `[`cbind`](https://rdrr.io/r/base/cbind.html)`(``treat_vs_none``, ``short_vs_long``)`\
\
`# center variable`\
`puppy_love``$``puppy_love`` ``<-`` ``puppy_love``$``puppy_love`` ``-`` `[`mean`](https://rdrr.io/r/base/mean.html)`(``puppy_love``$``puppy_love``)`\
\
`# fit model, with user defined contrasts`\
`m1`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``happiness`` ``~`` ``puppy_love`` ``*`` ``dose``, data ``=`` ``puppy_love``)`\
`# fit model without user defined contrasts`\
`m2`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``happiness`` ``~`` ``puppy_love`` ``*`` ``dose_original``, data ``=`` ``puppy_love``)`\
\
...
[`compare_parameters`](https://easystats.github.io/parameters/reference/compare_parameters.html)`(``m1``, ``m2``)`\
`#> Parameter                            |                   m1 |                   m2`\
`#> ----------------------------------------------------------------------------------`\
...
[`estimate_means`](https://easystats.github.io/modelbased/reference/estimate_means.md)`(``m2``, ``"dose_original"``)`\
...
[`estimate_contrasts`](https://easystats.github.io/modelbased/reference/estimate_contrasts.md)`(``m2``, ``"dose_original"``, comparison ``=`` ``"((b2+b3)/2) = b1"``)`\
...
[`estimate_contrasts`](https://easystats.github.io/modelbased/reference/estimate_contrasts.md)`(``m2``, ``"dose_original"``, comparison ``=`` ``"b3 = b2"``)`\
`#> Marginal Contrasts Analysis`\
`#> `\
`#> Parameter | Difference |   SE |        95% CI | t(24) |     p`\
`#> -------------------------------------------------------------`\
...
[`estimate_slopes`](https://easystats.github.io/modelbased/reference/estimate_slopes.md)`(``m2``, ``"puppy_love"``)`\
...
[`estimate_slopes`](https://easystats.github.io/modelbased/reference/estimate_slopes.md)`(``m2``, ``"puppy_love"``, by ``=`` ``"dose_original"``)`\
`#> Estimated Marginal Effects`\
`#> `\
...
`cond_tx`` ``<-`` `[`cbind`](https://rdrr.io/r/base/cbind.html)`(``"no treatment"`` ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``-``2`` ``/`` ``3``, ``0``, ``0``)``, ``"treatment"`` ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``0``, ``1`` ``/`` ``3``, ``1`` ``/`` ``3``)``)`\
\
`# marginal effect for "puppy_love" at average effect of "treatment" (short + long)`\
`# and "no treatment"`\
[`estimate_slopes`](https://easystats.github.io/modelbased/reference/estimate_slopes.md)`(``m2``, ``"puppy_love"``, by ``=`` ``"dose_original"``, comparison ``=`` ``cond_tx``)`\
`#> Estimated Marginal Effects`\
`#> `\
...
\
`# 2 way interaction`\
`m`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``alertness`` ``~`` ``time`` ``*`` ``coffee``, data ``=`` ``coffee_data``)`\
\
`# contrasts of pairwise comparisons of levels of "time" within the`\
`# different levels of "coffee"`\
[`estimate_contrasts`](https://easystats.github.io/modelbased/reference/estimate_contrasts.md)`(``m``, contrast ``=`` ``"time"``, by ``=`` ``"coffee"``)`\
`#> Marginal Contrasts Analysis`\
`#> `\
...
[`estimate_contrasts`](https://easystats.github.io/modelbased/reference/estimate_contrasts.md)`(``m``, contrast ``=`` ``"time"``, by ``=`` ``"coffee"``, comparison ``=`` ``"joint"``)`\
`#> Marginal Joint Test`\
`#> `\
...
\
`# 3 way interaction`\
`m`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``alertness`` ``~`` ``time`` ``*`` ``coffee`` ``*`` ``sex``, data ``=`` ``coffee_data``)`\
\
`# joint test of "time" levels within each group of coffee and sex`\
[`estimate_contrasts`](https://easystats.github.io/modelbased/reference/estimate_contrasts.md)`(`\
`  ``m``,`\
`  contrast ``=`` ``"time"``,`\
`  by ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"coffee"``, ``"sex"``)``,`\
`  comparison ``=`` ``"joint"`\
`)`\
`#> Marginal Joint Test`\
`#> `\
