...
- trend:
  ...
  `trend="<variable> = seq(1, 3, 0.1)"` (or similar) and omit the
  variable provided in `trend` from the `by` argument.
...
- p_adjust:
  ...
  `slope`, one in `by`). In this case, the `"esarey"` or `"sup-t"`
...
#> 
#>     Species Estimate Std. Error    t Pr(>|t|)    S   2.5 % 97.5 %  Df
#>  setosa        0.388     0.2602 1.49  0.13819  2.9 -0.1264  0.902 144
#>  versicolor    0.374     0.0961 3.89  < 0.001 12.7  0.1843  0.564 144
...
#>          2.31    0.332     0.0964 3.45   <0.001 10.4 0.142  0.523 144
#>          2.97    0.332     0.0964 3.45   <0.001 10.4 0.142  0.523 144
#>          3.62    0.332     0.0964 3.45   <0.001 10.4 0.142  0.523 144
#>          4.28    0.332     0.0964 3.45   <0.001 10.4 0.142  0.523 144
#>          4.93    0.332     0.0964 3.45   <0.001 10.4 0.142  0.523 144
#>          5.59    0.332     0.0964 3.45   <0.001 10.4 0.142  0.523 144
#>          6.24    0.332     0.0964 3.45   <0.001 10.4 0.142  0.523 144
#>          6.90    0.332     0.0964 3.45   <0.001 10.4 0.142  0.523 144
#> 
#> Term: Petal.Length
#> Type: response
#> Comparison: dY/dX
...
#> 
#>     Species Petal.Length Estimate Std. Error    t Pr(>|t|)    S   2.5 % 97.5 %
#>  setosa             1.00    0.388     0.2602 1.49  0.13819  2.9 -0.1264  0.902
#>  setosa             1.66    0.388     0.2602 1.49  0.13819  2.9 -0.1264  0.902
#>  versicolor         3.62    0.374     0.0961 3.89  < 0.001 12.7  0.1843  0.564
#>  versicolor         4.28    0.374     0.0961 3.89  < 0.001 12.7  0.1843  0.564
#>  versicolor         4.93    0.374     0.0961 3.89  < 0.001 12.7  0.1843  0.564
#>  virginica          4.93    0.234     0.0819 2.86  0.00483  7.7  0.0725  0.396
#>  virginica          5.59    0.234     0.0819 2.86  0.00483  7.7  0.0725  0.396
#>  virginica          6.24    0.234     0.0819 2.86  0.00483  7.7  0.0725  0.396
#>  virginica          6.90    0.234     0.0819 2.86  0.00483  7.7  0.0725  0.396
#>   Df
#>  144
#>  144
#>  144
