...
A sample data set from a course about the analysis of factorial designs,
by Mattan S. Ben-Shachar. See following link for more information:
...
- `time`: The time of day the participant was tested (morning, noon, or
  afternoon)
