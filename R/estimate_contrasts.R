...
#' @param post_process Optional formula, or list of formulas, to process subsequent
#' comparisons. It allows for complex, multi-step comparisons. After the initial
#' comparison in `comparison` is completed, the results are then post-processed
#' using the specified formula(s).
