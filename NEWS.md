...
* `estimate_contrast()` can now also calculate contrasts of average slopes. This
  can also be useful when estimating the context effects of within- and
  between-effects in a model.
