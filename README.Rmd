...
These functions are powered by the [`insight::get_datagrid()`](https://easystats.github.io/insight/reference/get_datagrid.html) function, a smart tool for guessing the appropriate reference grid.
