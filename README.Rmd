...
[![Build Status](https://travis-ci.org/easystats/modelbased.svg?branch=master)](https://travis-ci.org/easystats/modelbased)
...
Check-out [**this vignette**](https://easystats.github.io/modelbased/reference/estimate_means.html) to create this plot:
...
Check-out [**this vignette**](https://easystats.github.io/modelbased/reference/estimate_contrasts.html) to create this plot:
...
Check-out [**this vignette**](https://easystats.github.io/modelbased/reference/estimate_response.html) to create this plot:
...
See [**this vignette**](https://easystats.github.io/modelbased/reference/estimate_response.html) to create this plot:
