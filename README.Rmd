...
- **Solution**: You can estimate the marginal contrasts at different values of a contious variable (the *modulator*), and plot these differences (they are significant if their 95\% CI doesn't cover 0).
