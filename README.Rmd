...
- [**Visualisation matrix**](https://easystats.github.io/estimate/articles/visualisation_matrix.html)
...
These functions are powered by the [`visualisation_matrix()`](https://easystats.github.io/estimate/reference/visualisation_matrix.html) function, a smart tool for guessing the appropriate reference grid.
...
Check-out [**this vignette**](https://easystats.github.io/estimate/articles/visualisation_matrix.html) to create this plot:
...
Check-out [**this vignette**](https://easystats.github.io/estimate/reference/estimate_means.html) to create this plot:
...
Check-out [**this vignette**](https://easystats.github.io/estimate/reference/estimate_contrasts.html) to create this plot:
...
Check-out [**this vignette**](https://easystats.github.io/estimate/reference/estimate_response.html) to create this plot:
...
See [**this vignette**](https://easystats.github.io/estimate/reference/estimate_response.html) to create this plot:
