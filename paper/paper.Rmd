...
Their fundamental nature — that of being a statistical link between an outcome $y$ and predictor variables $X$ — enables the generation of predictions for any combination of predictors, observed or unobserved alike.
...
Two types of "marginalization" are provided by `modelbased`: 
