...
- **"total"**: Returns the sum of the random effect and its corresponding fixed effects, and can be interprested as the "absolute" values of the individual-level effects on the same scale as their corresponding fixed effects.
